...
- Name: t1_feature_coverage.spec.ts >> Tier 1 - Feature Coverage >> T1.21: Enter query in search bar and verify matching tile is highlighted
- Location: tests\e2e\specs\t1_feature_coverage.spec.ts:249:3
...
- generic [ref=e3]:
  - banner [ref=e4]:
    ...
    - generic [ref=e10]:
      - generic [ref=e11]:
        ...
        - generic [ref=e15]: "Success. Last Updated: 11:27:59 PM"
  ...
  - generic [ref=e17]:
    ...
    - generic [ref=e43]:
      ...
      - generic [ref=e45]:
        - textbox "Search e.g. AAPL, Tencent..." [active] [ref=e46]: AAPL
