...
- Name: t1_feature_coverage.spec.ts >> Tier 1 - Feature Coverage >> T1.4: Verify all tiles have symbol and change percentage text visible
- Location: tests\e2e\specs\t1_feature_coverage.spec.ts:92:3
...
Locator: locator('[data-testid="stock-symbol-MSFT"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="stock-symbol-MSFT"]')
...
- banner:
  ...
  - text: "Live Mode Success. Last Updated: 11:27:30 PM"
  - button "Refresh"
- text: Market
- button "US Market"
- button "HK Market"
